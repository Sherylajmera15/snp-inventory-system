...
interface ChemicalItemDetailProps {
  item: ChemicalItem;
  index: number;
}
...
export default function ChemicalItemDetail({ item, index }: ChemicalItemDetailProps) {
  return (
    <div className="border border-sand rounded-2xl p-5 bg-white">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs px-2 py-0.5 rounded-full bg-sand text-charcoal">{item.chemical_name}</span>
      </div>
